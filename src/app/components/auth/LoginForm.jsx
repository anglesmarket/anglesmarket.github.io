    ...
    <form className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          className="px-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 text-lg bg-gray-50"
          autoComplete="email"
        />
      </div>
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          <input
            ...
            placeholder="••••••••"
            className="px-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 text-lg bg-gray-50 w-full"
            autoComplete="current-password"
          />
          <button
            type="button"
            className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-blue-500 text-lg"
      ...
      <button
        type="submit"
        className="bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-xl py-3 text-lg shadow-lg transition-all duration-200 mt-2"
      >
        Login
      </button>
      <div className="flex gap-3 mt-4 justify-center">
        <button type="button" className="flex items-center justify-center bg-white border border-gray-300 rounded-full p-2 shadow hover:bg-gray-50 transition-all" aria-label="Login with Google">
        ...
        <button type="button" className="flex items-center justify-center bg-white border border-gray-300 rounded-full p-2 shadow hover:bg-gray-50 transition-all" aria-label="Login with GitHub">
        ...
        <button type="button" className="flex items-center justify-center bg-white border border-gray-300 rounded-full p-2 shadow hover:bg-gray-50 transition-all" aria-label="Login with LinkedIn">
